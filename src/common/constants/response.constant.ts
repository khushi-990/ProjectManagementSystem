export const RESPONSE_SUCCESS = {
  ...
  PROJECT_INSERTED: "Project Created",
  PROJECT_LISTED: "Project Listed",
  PROJECT_DETAILS: "Project Detailed successfully",
  ...
  TASK_INSERTED: "Task Created",
  TASK_LISTED: "Task Listed",
  TASK_DETAILED: "Task Detailed successfully",
...
export const RESPONSE_ERROR = {
  ...
  FILE_INVALID_EXTENSION: "Only jpg,JPG,pdf,svg files are allowed!!"
