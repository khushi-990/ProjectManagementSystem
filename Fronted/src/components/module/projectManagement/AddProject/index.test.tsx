...
describe('AddProject', () => {
  ...
  test('Add project page should render heading', () => {
  ...
  test('Add project page should render input element', () => {
    waitFor(() => {
      const titleInput = screen.getByPlaceholderText(/enter project name\.\.\./i);
  ...
  test('submitting form with invalid email displays error', () => {
    waitFor(async () => {
      ...
      expect(screen.getByText('Please enter project name')).toBeInTheDocument();
    });
  });
